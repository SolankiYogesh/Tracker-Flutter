...
Welcome to the **GeoPulsify** project documentation. This document is designed to help new developers understand the architecture, logic flow, and core functionalities of the application.
